...
### Hyperparameters
An exhaustive grid search was performed to find the optimal balance between task learning ($\alpha$) and regularization ($\beta$).

<div align="center">
  <img src="https://i.postimg.cc/Y0GnvNCd/hyperparam-study-analysis.png" alt="Hyperparameter Heatmap" width="900"/>
  <br />
  <em>Fig 3: Hyperparameter search for Alpha and Beta. The sweet spot was found at α=0.6, β=1.0.</em>
</div>

* **Backbone:** ViT-B/16
* **Epochs:** 15
* **Learning Rate:** 0.002 (Cosine Annealing)
* **Alpha ($\alpha$):** 0.6 (Balances CE and Visual Distillation)
* **Beta ($\beta$):** 1.0 (Text regularization strength)
